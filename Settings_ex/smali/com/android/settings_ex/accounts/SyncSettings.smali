...
.method private removeAccountPreferences()V
    ...
    .prologue
    .line 131
    invoke-virtual {p0}, Lcom/android/settings_ex/accounts/SyncSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method private startAccountSettings(Lcom/android/settings_ex/AccountPreference;)V
    ...
    .line 117
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/accounts/SyncSettings;->startActivity(Landroid/content/Intent;)V

    .line 118
    invoke-virtual {p0}, Lcom/android/settings_ex/accounts/SyncSettings;->finish()V
...
.method public onAccountsUpdated([Landroid/accounts/Account;)V
    ...
    .prologue
    .line 143
    invoke-virtual {p0}, Lcom/android/settings_ex/accounts/SyncSettings;->getActivity()Landroid/app/Activity;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/accounts/SyncSettings;->getDrawableForType(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/accounts/SyncSettings;->getLabelForType(Ljava/lang/String;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/settings_ex/AccountPreference;->setSummary(Ljava/lang/CharSequence;)V
    ...
    :cond_5
    invoke-virtual {p0}, Lcom/android/settings_ex/accounts/SyncSettings;->onSyncStateUpdated()V
...
.method protected onAuthDescriptionsUpdated()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/accounts/SyncSettings;->getDrawableForType(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    invoke-virtual {v0, v3}, Lcom/android/settings_ex/AccountPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/accounts/SyncSettings;->getLabelForType(Ljava/lang/String;)Ljava/lang/CharSequence;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/accounts/SyncSettings;->addPreferencesFromResource(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/accounts/SyncSettings;->setHasOptionsMenu(Z)V
