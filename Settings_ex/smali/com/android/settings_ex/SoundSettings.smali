...
.method static synthetic access$200(Lcom/android/settings_ex/SoundSettings;Landroid/content/Intent;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$300(Lcom/android/settings_ex/SoundSettings;ILandroid/preference/Preference;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private handleDockChange(Landroid/content/Intent;)V
    ...
    :try_start_0
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/SoundSettings;->removeDialog(I)V
    :try_end_0
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/SoundSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method private needsDockSettings()Z
    ...
    .prologue
    .line 362
    invoke-virtual {p0}, Lcom/android/settings_ex/SoundSettings;->getResources()Landroid/content/res/Resources;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v12}, Lcom/android/settings_ex/SoundSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Landroid/media/AudioManager;

    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mAudioManager:Landroid/media/AudioManager;

    .line 137
    const v12, 0x7f050039

    invoke-virtual {p0, v12}, Lcom/android/settings_ex/SoundSettings;->addPreferencesFromResource(I)V
    ...
    invoke-virtual {p0, v13}, Lcom/android/settings_ex/SoundSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v12}, Lcom/android/settings_ex/SoundSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mVibrateWhenRinging:Landroid/preference/CheckBoxPreference;

    .line 149
    iget-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mVibrateWhenRinging:Landroid/preference/CheckBoxPreference;
    ...
    .line 150
    iget-object v13, p0, Lcom/android/settings_ex/SoundSettings;->mVibrateWhenRinging:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mDtmfTone:Landroid/preference/CheckBoxPreference;

    .line 154
    iget-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mDtmfTone:Landroid/preference/CheckBoxPreference;
    ...
    .line 155
    iget-object v13, p0, Lcom/android/settings_ex/SoundSettings;->mDtmfTone:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mSoundEffects:Landroid/preference/CheckBoxPreference;

    .line 158
    iget-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mSoundEffects:Landroid/preference/CheckBoxPreference;
    ...
    .line 159
    iget-object v13, p0, Lcom/android/settings_ex/SoundSettings;->mSoundEffects:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mHapticFeedback:Landroid/preference/CheckBoxPreference;

    .line 162
    iget-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mHapticFeedback:Landroid/preference/CheckBoxPreference;
    ...
    .line 163
    iget-object v13, p0, Lcom/android/settings_ex/SoundSettings;->mHapticFeedback:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mLockSounds:Landroid/preference/CheckBoxPreference;

    .line 166
    iget-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mLockSounds:Landroid/preference/CheckBoxPreference;
    ...
    .line 167
    iget-object v13, p0, Lcom/android/settings_ex/SoundSettings;->mLockSounds:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mRingtonePreference:Landroid/preference/Preference;
    ...
    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mNotificationPreference:Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v12}, Lcom/android/settings_ex/SoundSettings;->removePreference(Ljava/lang/String;)V
    ...
    invoke-static {v12}, Lcom/android/settings_ex/Utils;->isVoiceCapable(Landroid/content/Context;)Z
    ...
    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mSoundSettings:Landroid/preference/PreferenceGroup;

    .line 192
    iget-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mSoundSettings:Landroid/preference/PreferenceGroup;
    ...
    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mMusicFx:Landroid/preference/Preference;
    ...
    invoke-virtual {p0}, Lcom/android/settings_ex/SoundSettings;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    iget-object v13, p0, Lcom/android/settings_ex/SoundSettings;->mMusicFx:Landroid/preference/Preference;
    ...
    .line 206
    sget-object v1, Lcom/android/settings_ex/SoundSettings;->NEED_VOICE_CAPABILITY:[Ljava/lang/String;
    ...
    invoke-virtual {p0, v8}, Lcom/android/settings_ex/SoundSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    :cond_d
    new-instance v12, Lcom/android/settings_ex/SoundSettings$3;

    invoke-direct {v12, p0}, Lcom/android/settings_ex/SoundSettings$3;-><init>(Lcom/android/settings_ex/SoundSettings;)V

    iput-object v12, p0, Lcom/android/settings_ex/SoundSettings;->mRingtoneLookupRunnable:Ljava/lang/Runnable;

    .line 227
    invoke-direct {p0}, Lcom/android/settings_ex/SoundSettings;->initDockSettings()V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 280
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mVibrateWhenRinging:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v9, p0, Lcom/android/settings_ex/SoundSettings;->mVibrateWhenRinging:Landroid/preference/CheckBoxPreference;
    ...
    .line 283
    :cond_3
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mDtmfTone:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v9, p0, Lcom/android/settings_ex/SoundSettings;->mDtmfTone:Landroid/preference/CheckBoxPreference;
    ...
    .line 287
    :cond_5
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mSoundEffects:Landroid/preference/CheckBoxPreference;
    ...
    .line 289
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mAudioManager:Landroid/media/AudioManager;
    ...
    iget-object v9, p0, Lcom/android/settings_ex/SoundSettings;->mSoundEffects:Landroid/preference/CheckBoxPreference;
    ...
    .line 296
    :cond_8
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mHapticFeedback:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v9, p0, Lcom/android/settings_ex/SoundSettings;->mHapticFeedback:Landroid/preference/CheckBoxPreference;
    ...
    .line 300
    :cond_a
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mLockSounds:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v9, p0, Lcom/android/settings_ex/SoundSettings;->mLockSounds:Landroid/preference/CheckBoxPreference;
    ...
    .line 304
    :cond_c
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mMusicFx:Landroid/preference/Preference;

    if-eq p2, v7, :cond_2

    .line 307
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mDockAudioSettings:Landroid/preference/Preference;

    if-ne p2, v7, :cond_12

    .line 308
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mDockIntent:Landroid/content/Intent;
    ...
    .line 313
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/SoundSettings;->showDialog(I)V
    ...
    iget-object v5, p0, Lcom/android/settings_ex/SoundSettings;->mDockIntent:Landroid/content/Intent;

    invoke-direct {v2, v5}, Landroid/content/Intent;-><init>(Landroid/content/Intent;)V

    .line 319
    .local v2, i:Landroid/content/Intent;
    const-string v5, "com.android.settings_ex.bluetooth.action.DOCK_SHOW_UI"
    ...
    :cond_10
    iget-object v4, p0, Lcom/android/settings_ex/SoundSettings;->mDockAudioSettings:Landroid/preference/Preference;
    ...
    .line 328
    invoke-super {p0, v4, v4}, Lcom/android/settings_ex/SettingsPreferenceFragment;->onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    :cond_12
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mDockSounds:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v9, p0, Lcom/android/settings_ex/SoundSettings;->mDockSounds:Landroid/preference/CheckBoxPreference;
    ...
    .line 334
    :cond_14
    iget-object v7, p0, Lcom/android/settings_ex/SoundSettings;->mDockAudioMediaEnabled:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v9, p0, Lcom/android/settings_ex/SoundSettings;->mDockAudioMediaEnabled:Landroid/preference/CheckBoxPreference;
