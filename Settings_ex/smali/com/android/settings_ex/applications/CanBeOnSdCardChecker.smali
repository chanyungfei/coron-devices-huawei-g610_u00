...
.method init()V
    ...
    .line 101
    :try_start_0
    iget-object v1, p0, Lcom/android/settings_ex/applications/CanBeOnSdCardChecker;->mPm:Landroid/content/pm/IPackageManager;

    invoke-interface {v1}, Landroid/content/pm/IPackageManager;->getInstallLocation()I

    move-result v1

    iput v1, p0, Lcom/android/settings_ex/applications/CanBeOnSdCardChecker;->mInstallLocation:I
    :try_end_0
