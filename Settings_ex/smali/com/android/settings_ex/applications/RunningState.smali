...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/RunningState;->mUsers:Landroid/util/SparseArray;
...
.method private addOtherUserItem(Landroid/content/Context;Ljava/util/ArrayList;Landroid/util/SparseArray;Lcom/android/settings_ex/applications/RunningState$MergedItem;)V
    ...
    .line 813
    iget v4, p4, Lcom/android/settings_ex/applications/RunningState$BaseItem;->mUserId:I
    ...
    .line 814
    .local v3, userItem:Lcom/android/settings_ex/applications/RunningState$MergedItem;
    if-eqz v3, :cond_0

    iget v4, v3, Lcom/android/settings_ex/applications/RunningState$BaseItem;->mCurSeq:I

    iget v7, p0, Lcom/android/settings_ex/applications/RunningState;->mSequence:I
    ...
    .line 817
    new-instance v3, Lcom/android/settings_ex/applications/RunningState$MergedItem;

    .end local v3           #userItem:Lcom/android/settings_ex/applications/RunningState$MergedItem;
    iget v4, p4, Lcom/android/settings_ex/applications/RunningState$BaseItem;->mUserId:I

    invoke-direct {v3, v4}, Lcom/android/settings_ex/applications/RunningState$MergedItem;-><init>(I)V

    .line 818
    .restart local v3       #userItem:Lcom/android/settings_ex/applications/RunningState$MergedItem;
    iget v4, p4, Lcom/android/settings_ex/applications/RunningState$BaseItem;->mUserId:I
    ...
    iput v4, v3, Lcom/android/settings_ex/applications/RunningState$BaseItem;->mCurSeq:I

    .line 823
    iget-object v4, p0, Lcom/android/settings_ex/applications/RunningState;->mUsers:Landroid/util/SparseArray;

    iget v7, p4, Lcom/android/settings_ex/applications/RunningState$BaseItem;->mUserId:I

    invoke-virtual {v4, v7}, Landroid/util/SparseArray;->get(I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/android/settings_ex/applications/RunningState$UserState;

    iput-object v4, v3, Lcom/android/settings_ex/applications/RunningState$MergedItem;->mUser:Lcom/android/settings_ex/applications/RunningState$UserState;

    if-nez v4, :cond_3

    .line 824
    new-instance v4, Lcom/android/settings_ex/applications/RunningState$UserState;

    invoke-direct {v4}, Lcom/android/settings_ex/applications/RunningState$UserState;-><init>()V
    ...
    iget-object v4, v3, Lcom/android/settings_ex/applications/RunningState$MergedItem;->mUser:Lcom/android/settings_ex/applications/RunningState$UserState;

    iput-object v1, v4, Lcom/android/settings_ex/applications/RunningState$UserState;->mInfo:Landroid/content/pm/UserInfo;
    ...
    iget-object v7, p0, Lcom/android/settings_ex/applications/RunningState;->mUm:Landroid/os/UserManager;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v8

    invoke-static {v7, v1, v8}, Lcom/android/settings_ex/users/UserUtils;->getUserIcon(Landroid/os/UserManager;Landroid/content/pm/UserInfo;Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;

    move-result-object v7

    iput-object v7, v4, Lcom/android/settings_ex/applications/RunningState$UserState;->mIcon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v5, v4, Lcom/android/settings_ex/applications/RunningState$UserState;->mLabel:Ljava/lang/String;
    ...
    .line 840
    :cond_4
    iget-object v4, v3, Lcom/android/settings_ex/applications/RunningState$MergedItem;->mChildren:Ljava/util/ArrayList;
...
.method private reset()V
    ...
    .line 808
    iget-object v0, p0, Lcom/android/settings_ex/applications/RunningState;->mUsers:Landroid/util/SparseArray;
...
.method private update(Landroid/content/Context;Landroid/app/ActivityManager;)Z
    ...
    new-instance v62, Lcom/android/settings_ex/applications/RunningState$AppProcessInfo;
    ...
    check-cast v12, Lcom/android/settings_ex/applications/RunningState$AppProcessInfo;

    .line 894
    .local v12, ainfo:Lcom/android/settings_ex/applications/RunningState$AppProcessInfo;
    if-eqz v12, :cond_6
    ...
    iput-boolean v0, v12, Lcom/android/settings_ex/applications/RunningState$AppProcessInfo;->hasServices:Z
    ...
    iput-boolean v0, v12, Lcom/android/settings_ex/applications/RunningState$AppProcessInfo;->hasForegroundServices:Z

    .line 890
    .end local v12           #ainfo:Lcom/android/settings_ex/applications/RunningState$AppProcessInfo;
    :cond_6
    add-int/lit8 v25, v25, 0x1
    ...
    .line 914
    .restart local v12       #ainfo:Lcom/android/settings_ex/applications/RunningState$AppProcessInfo;
    if-eqz v12, :cond_b

    iget-boolean v0, v12, Lcom/android/settings_ex/applications/RunningState$AppProcessInfo;->hasForegroundServices:Z
    ...
    .line 920
    iget-object v0, v12, Lcom/android/settings_ex/applications/RunningState$AppProcessInfo;->info:Landroid/app/ActivityManager$RunningAppProcessInfo;
    ...
    .line 927
    iget-boolean v0, v12, Lcom/android/settings_ex/applications/RunningState$AppProcessInfo;->hasServices:Z
    ...
    .line 941
    .local v48, procs:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/settings_ex/applications/RunningState$ProcessItem;>;"
    if-nez v48, :cond_c

    .line 942
    new-instance v48, Ljava/util/HashMap;

    .end local v48           #procs:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/settings_ex/applications/RunningState$ProcessItem;>;"
    invoke-direct/range {v48 .. v48}, Ljava/util/HashMap;-><init>()V

    .line 943
    .restart local v48       #procs:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/settings_ex/applications/RunningState$ProcessItem;>;"
    move-object/from16 v0, p0
    ...
    check-cast v46, Lcom/android/settings_ex/applications/RunningState$ProcessItem;

    .line 946
    .local v46, proc:Lcom/android/settings_ex/applications/RunningState$ProcessItem;
    if-nez v46, :cond_d
    ...
    .line 948
    new-instance v46, Lcom/android/settings_ex/applications/RunningState$ProcessItem;

    .end local v46           #proc:Lcom/android/settings_ex/applications/RunningState$ProcessItem;
    move-object/from16 v0, v53
    ...
    .line 949
    .restart local v46       #proc:Lcom/android/settings_ex/applications/RunningState$ProcessItem;
    move-object/from16 v0, v53
    ...
    check-cast v18, Lcom/android/settings_ex/applications/RunningState$ProcessItem;

    .line 1016
    .local v18, client:Lcom/android/settings_ex/applications/RunningState$ProcessItem;
    if-nez v18, :cond_19
    ...
    .end local v18           #client:Lcom/android/settings_ex/applications/RunningState$ProcessItem;
    check-cast v18, Lcom/android/settings_ex/applications/RunningState$ProcessItem;

    .line 1019
    .restart local v18       #client:Lcom/android/settings_ex/applications/RunningState$ProcessItem;
    :cond_19
    if-eqz v18, :cond_1a
    ...
    .line 1064
    .local v44, pit:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/settings_ex/applications/RunningState$ProcessItem;>;"
    :cond_23
    :goto_11
    ...
    .line 1088
    .local v54, sit:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/settings_ex/applications/RunningState$ServiceItem;>;"
    :cond_25
    :goto_12
    ...
    check-cast v53, Lcom/android/settings_ex/applications/RunningState$ServiceItem;

    .line 1090
    .local v53, si:Lcom/android/settings_ex/applications/RunningState$ServiceItem;
    move-object/from16 v0, v53
    ...
    .line 1074
    .end local v53           #si:Lcom/android/settings_ex/applications/RunningState$ServiceItem;
    .end local v54           #sit:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/settings_ex/applications/RunningState$ServiceItem;>;"
    :cond_26
    const/16 v17, 0x1
    ...
    .line 1098
    .end local v44           #pit:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/settings_ex/applications/RunningState$ProcessItem;>;"
    .end local v48           #procs:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/settings_ex/applications/RunningState$ProcessItem;>;"
    :cond_2a
    if-eqz v58, :cond_2b
    ...
    .line 1108
    .local v56, sortedProcesses:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/settings_ex/applications/RunningState$ProcessItem;>;"
    const/16 v25, 0x0
    ...
    .line 1114
    .restart local v53       #si:Lcom/android/settings_ex/applications/RunningState$ServiceItem;
    move-object/from16 v0, v53
    ...
    .line 1136
    .local v40, otherUsers:Landroid/util/SparseArray;,"Landroid/util/SparseArray<Lcom/android/settings_ex/applications/RunningState$MergedItem;>;"
    move-object/from16 v0, p0
    ...
    iget v0, v0, Lcom/android/settings_ex/applications/RunningState$BaseItem;->mUserId:I
    ...
    .line 1198
    new-instance v60, Lcom/android/settings_ex/applications/RunningState$MergedItem;
    ...
    invoke-direct/range {v60 .. v61}, Lcom/android/settings_ex/applications/RunningState$MergedItem;-><init>(I)V
    ...
    check-cast v59, Lcom/android/settings_ex/applications/RunningState$MergedItem;

    .line 1217
    .local v59, user:Lcom/android/settings_ex/applications/RunningState$MergedItem;
    ...
    .line 1222
    .end local v59           #user:Lcom/android/settings_ex/applications/RunningState$MergedItem;
    :cond_3f
    move-object/from16 v0, p0
    ...
    .end local v40           #otherUsers:Landroid/util/SparseArray;,"Landroid/util/SparseArray<Lcom/android/settings_ex/applications/RunningState$MergedItem;>;"
    .end local v56           #sortedProcesses:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/settings_ex/applications/RunningState$ProcessItem;>;"
    :cond_40
    move-object/from16 v0, p0
    ...
    .restart local v40       #otherUsers:Landroid/util/SparseArray;,"Landroid/util/SparseArray<Lcom/android/settings_ex/applications/RunningState$MergedItem;>;"
    .restart local v56       #sortedProcesses:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/settings_ex/applications/RunningState$ProcessItem;>;"
    :catchall_0
    move-exception v60
    ...
    check-cast v60, Lcom/android/settings_ex/applications/RunningState$ProcessItem;
    ...
    .line 1352
    .restart local v59       #user:Lcom/android/settings_ex/applications/RunningState$MergedItem;
    move-object/from16 v0, v59
    ...
    iput-wide v13, v0, Lcom/android/settings_ex/applications/RunningState;->mBackgroundProcessMemory:J
...
.method getCurrentItems()Ljava/util/ArrayList;
    ...
    .line 1389
    :try_start_0
    iget-object v0, p0, Lcom/android/settings_ex/applications/RunningState;->mItems:Ljava/util/ArrayList;
