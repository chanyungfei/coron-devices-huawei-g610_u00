...
.field private mTetherSettings:Lcom/android/settings_ex/TetherSettings;
...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/Switch;Landroid/preference/Preference;Landroid/preference/Preference;)V
    ...
    iput v0, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mTetherChoice:I
    ...
    .line 106
    iput-object p2, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitch:Landroid/widget/Switch;

    .line 107
    iput-object p3, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mWpsConnectPre:Landroid/preference/Preference;

    .line 108
    iput-object p4, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mBandwidthPre:Landroid/preference/Preference;

    .line 109
    invoke-virtual {p0, p1}, Lcom/android/settings_ex/wifi/WifiApEnabler;->init(Landroid/content/Context;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/mediatek/wifi/hotspot/HotspotSwitchPreference;)V
    ...
    .line 114
    iput-object p2, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitchPreference:Lcom/mediatek/wifi/hotspot/HotspotSwitchPreference;

    .line 115
    iget-object v0, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitchPreference:Lcom/mediatek/wifi/hotspot/HotspotSwitchPreference;
...
.method static synthetic access$100(Lcom/android/settings_ex/wifi/WifiApEnabler;[Ljava/lang/Object;[Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    .prologue
    .line 43
    invoke-direct {p0, p1, p2, p3}, Lcom/android/settings_ex/wifi/WifiApEnabler;->updateTetherStateForIpv6([Ljava/lang/Object;[Ljava/lang/Object;[Ljava/lang/Object;)V
...
.method private enableWifiCheckBox()V
    ...
    .line 162
    invoke-direct {p0, v1}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setSwitchEnabled(Z)V
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitch:Landroid/widget/Switch;

    if-nez v1, :cond_2

    .line 165
    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitchPreference:Lcom/mediatek/wifi/hotspot/HotspotSwitchPreference;
    ...
    .line 167
    :cond_2
    invoke-direct {p0, v2}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setSwitchEnabled(Z)V
...
.method private handleWifiApStateChanged(I)V
    ...
    .line 326
    :pswitch_0
    invoke-direct {p0, v0}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setSwitchEnabled(Z)V

    .line 327
    invoke-direct {p0, v0}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setPreferenceState(Z)V

    .line 328
    invoke-direct {p0, v0}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setStartTime(Z)V

    .line 329
    iget-object v0, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitch:Landroid/widget/Switch;
    ...
    .line 338
    :pswitch_1
    invoke-direct {p0, v1}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setSwitchChecked(Z)V

    .line 339
    invoke-direct {p0, v1}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setSwitchEnabled(Z)V

    .line 340
    invoke-direct {p0, v1}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setPreferenceState(Z)V

    .line 341
    invoke-direct {p0, v1}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setStartTime(Z)V
    ...
    .line 352
    :pswitch_3
    invoke-direct {p0, v0}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setSwitchChecked(Z)V
...
.method private setPreferenceState(Z)V
    ...
    .line 383
    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mBandwidthPre:Landroid/preference/Preference;

    invoke-virtual {v1, p1}, Landroid/preference/Preference;->setEnabled(Z)V

    .line 384
    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 389
    :cond_0
    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mWpsConnectPre:Landroid/preference/Preference;
...
.method private setSwitchChecked(Z)V
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mStateMachineEvent:Z
...
.method private startProvisioningIfNecessary(I)V
    ...
    .line 421
    iput p1, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mTetherChoice:I

    .line 422
    invoke-virtual {p0}, Lcom/android/settings_ex/wifi/WifiApEnabler;->isProvisioningNeeded()Z
    ...
    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mProvisionApp:[Ljava/lang/String;

    aget-object v1, v1, v4

    iget-object v2, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mProvisionApp:[Ljava/lang/String;
    ...
    .line 425
    invoke-virtual {p0}, Lcom/android/settings_ex/wifi/WifiApEnabler;->getActivity()Landroid/app/Activity;
    ...
    .line 428
    :cond_0
    invoke-direct {p0}, Lcom/android/settings_ex/wifi/WifiApEnabler;->startTethering()V
...
.method private startTethering()V
    ...
    .prologue
    .line 440
    iget v0, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mTetherChoice:I
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setSoftapEnabled(Z)V
...
.method private updateTetherState([Ljava/lang/Object;[Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    .line 317
    iget-object v12, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitch:Landroid/widget/Switch;

    if-nez v12, :cond_6

    .line 318
    iget-object v12, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitchPreference:Lcom/mediatek/wifi/hotspot/HotspotSwitchPreference;
...
.method private updateTetherStateForIpv6([Ljava/lang/Object;[Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    iget-object v2, v0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mWifiRegexs:[Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mCm:Landroid/net/ConnectivityManager;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual {v0, v11}, Lcom/android/settings_ex/wifi/WifiApEnabler;->updateConfigSummary(Landroid/net/wifi/WifiConfiguration;)V

    .line 265
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mContext:Landroid/content/Context;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mTetherSettings:Lcom/android/settings_ex/TetherSettings;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitch:Landroid/widget/Switch;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitchPreference:Lcom/mediatek/wifi/hotspot/HotspotSwitchPreference;
    ...
    invoke-virtual {v0, v12, v13}, Lcom/android/settings_ex/TetherSettings;->getIPV6String(II)Ljava/lang/String;
...
.method public init(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mProvisionApp:[Ljava/lang/String;
...
.method isProvisioningNeeded()Z
    ...
    .prologue
    .line 418
    iget-object v0, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mProvisionApp:[Ljava/lang/String;
...
.method public onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    .line 407
    iget-boolean v0, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mStateMachineEvent:Z
    ...
    .line 412
    invoke-direct {p0, v3}, Lcom/android/settings_ex/wifi/WifiApEnabler;->startProvisioningIfNecessary(I)V

    goto :goto_0

    .line 414
    :cond_1
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setSoftapEnabled(Z)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 397
    invoke-direct {p0, v4}, Lcom/android/settings_ex/wifi/WifiApEnabler;->startProvisioningIfNecessary(I)V
    ...
    :cond_1
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setSoftapEnabled(Z)V
...
.method public setSoftapEnabled(Z)V
    ...
    .line 185
    invoke-direct {p0, v6}, Lcom/android/settings_ex/wifi/WifiApEnabler;->setSwitchEnabled(Z)V
    ...
    .line 187
    :cond_4
    iget-object v4, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitch:Landroid/widget/Switch;

    if-nez v4, :cond_2

    .line 188
    iget-object v4, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mSwitchPreference:Lcom/mediatek/wifi/hotspot/HotspotSwitchPreference;
...
.method public setTetherSettings(Lcom/android/settings_ex/TetherSettings;)V
    .locals 0
    .parameter "tetherSettings"

    .prologue
    .line 289
    iput-object p1, p0, Lcom/android/settings_ex/wifi/WifiApEnabler;->mTetherSettings:Lcom/android/settings_ex/TetherSettings;
