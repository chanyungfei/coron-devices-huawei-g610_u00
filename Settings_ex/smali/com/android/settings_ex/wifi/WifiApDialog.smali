...
.field mExt:Lcom/android/settings_ex/ext/IWifiApDialogExt;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/DialogInterface$OnClickListener;Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 81
    iput v0, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannel:I

    .line 82
    iput v0, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannelWidth:I
...
.method static synthetic access$002(Lcom/android/settings_ex/wifi/WifiApDialog;I)I
    ...
    .prologue
    .line 57
    iput p1, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannel:I
...
.method static synthetic access$100(Lcom/android/settings_ex/wifi/WifiApDialog;)[Ljava/lang/String;
    ...
    .prologue
    .line 57
    iget-object v0, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannelList:[Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$202(Lcom/android/settings_ex/wifi/WifiApDialog;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 57
    iput p1, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannelWidth:I
...
.method private isWpa2Only()Z
    ...
    .line 420
    .local v0, wpa2Only:Z
    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mExt:Lcom/android/settings_ex/ext/IWifiApDialogExt;

    const/4 v2, 0x0

    invoke-interface {v1, v2}, Lcom/android/settings_ex/ext/IWifiApDialogExt;->getSecurityType(I)I
    ...
    iget-boolean v1, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mWpaNonsupport:Z
...
.method public getConfig()Landroid/net/wifi/WifiConfiguration;
    ...
    .line 125
    iget v2, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannel:I

    iput v2, v0, Landroid/net/wifi/WifiConfiguration;->channel:I

    .line 126
    iget v2, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannelWidth:I
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v5, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mContext:Landroid/content/Context;
    ...
    .line 348
    iget-boolean v3, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mWpaNonsupport:Z

    if-eqz v3, :cond_4

    .line 349
    invoke-direct {p0}, Lcom/android/settings_ex/wifi/WifiApDialog;->isWpa2Only()Z
    ...
    .line 350
    iget-object v3, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mSecurity:Landroid/widget/Spinner;
    ...
    iget-object v4, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mExt:Lcom/android/settings_ex/ext/IWifiApDialogExt;

    iget v5, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mSecurityTypeIndex:I

    invoke-interface {v4, v5}, Lcom/android/settings_ex/ext/IWifiApDialogExt;->getSelection(I)I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 157
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/wifi/WifiApDialog;->getContext()Landroid/content/Context;

    move-result-object v6

    .line 159
    .local v6, context:Landroid/content/Context;
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/wifi/WifiApDialog;->getLayoutInflater()Landroid/view/LayoutInflater;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mView:Landroid/view/View;

    .line 160
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mView:Landroid/view/View;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mSecurity:Landroid/widget/Spinner;

    .line 162
    invoke-static {v6}, Lcom/android/settings_ex/Utils;->getWifiApDialogPlugin(Landroid/content/Context;)Lcom/android/settings_ex/ext/IWifiApDialogExt;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mExt:Lcom/android/settings_ex/ext/IWifiApDialogExt;
    ...
    iput-boolean v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mWpaNonsupport:Z

    .line 164
    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mWpaNonsupport:Z
    ...
    .line 168
    invoke-direct/range {p0 .. p0}, Lcom/android/settings_ex/wifi/WifiApDialog;->isWpa2Only()Z
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mSecurity:Landroid/widget/Spinner;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mMaxConnSpinner:Landroid/widget/Spinner;

    .line 178
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mMaxConnSpinner:Landroid/widget/Spinner;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/wifi/WifiApDialog;->setView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/wifi/WifiApDialog;->setInverseBackgroundForced(Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/wifi/WifiApDialog;->setTitle(I)V
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mSsid:Landroid/widget/TextView;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mPassword:Landroid/widget/EditText;

    .line 188
    const/16 v17, -0x1

    const v18, 0x7f0b048f
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mListener:Landroid/content/DialogInterface$OnClickListener;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/settings_ex/wifi/WifiApDialog;->setButton(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mSsid:Landroid/widget/TextView;
    ...
    iget v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mSecurityTypeIndex:I
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mPassword:Landroid/widget/EditText;
    ...
    iput v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannel:I
    ...
    iput v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannelWidth:I

    .line 220
    :cond_3
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mContext:Landroid/content/Context;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mLinearLayout:Landroid/widget/LinearLayout;

    .line 228
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mLinearLayout:Landroid/widget/LinearLayout;
    ...
    new-instance v20, Lcom/android/settings_ex/wifi/Utf8ByteLengthFilter;

    const/16 v21, 0x20

    invoke-direct/range {v20 .. v21}, Lcom/android/settings_ex/wifi/Utf8ByteLengthFilter;-><init>(I)V
    ...
    .line 322
    invoke-direct/range {p0 .. p0}, Lcom/android/settings_ex/wifi/WifiApDialog;->showSecurityFields()V

    .line 323
    invoke-direct/range {p0 .. p0}, Lcom/android/settings_ex/wifi/WifiApDialog;->validate()V
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mExt:Lcom/android/settings_ex/ext/IWifiApDialogExt;
    ...
    invoke-interface {v0, v6, v1, v2}, Lcom/android/settings_ex/ext/IWifiApDialogExt;->setAdapter(Landroid/content/Context;Landroid/widget/Spinner;I)V
    ...
    invoke-interface/range {v18 .. v19}, Lcom/android/settings_ex/ext/IWifiApDialogExt;->getSelection(I)I
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannelList:[Ljava/lang/String;

    .line 248
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannelList:[Ljava/lang/String;
    ...
    iget v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannel:I
    ...
    .line 267
    new-instance v17, Lcom/android/settings_ex/wifi/WifiApDialog$1;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/settings_ex/wifi/WifiApDialog$1;-><init>(Lcom/android/settings_ex/wifi/WifiApDialog;)V
    ...
    iget v0, v0, Lcom/android/settings_ex/wifi/WifiApDialog;->mChannelWidth:I
    ...
    .line 289
    new-instance v17, Lcom/android/settings_ex/wifi/WifiApDialog$2;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/settings_ex/wifi/WifiApDialog$2;-><init>(Lcom/android/settings_ex/wifi/WifiApDialog;)V
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-interface {v1, p3}, Lcom/android/settings_ex/ext/IWifiApDialogExt;->getSecurityType(I)I
    ...
    .line 392
    :cond_4
    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiApDialog;->mMaxConnSpinner:Landroid/widget/Spinner;
