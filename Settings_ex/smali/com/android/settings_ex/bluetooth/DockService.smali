...
.method private createDialog(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    iget-object v6, v0, Lcom/android/settings_ex/bluetooth/DockService;->mDialog:Landroid/app/AlertDialog;
    ...
    iput-object v6, v0, Lcom/android/settings_ex/bluetooth/DockService;->mDialog:Landroid/app/AlertDialog;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/bluetooth/DockService;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-virtual {v0, v6, v8}, Lcom/android/settings_ex/bluetooth/DockService;->startForeground(ILandroid/app/Notification;)V
    ...
    invoke-virtual {v0, v6}, Lcom/android/settings_ex/bluetooth/DockService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v0, v6}, Lcom/android/settings_ex/bluetooth/LocalBluetoothPreferences;->hasDockAutoConnectSetting(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v1, v2, v11}, Lcom/android/settings_ex/bluetooth/DockService;->initBtSettings(Landroid/bluetooth/BluetoothDevice;IZ)[Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v6}, Lcom/android/settings_ex/bluetooth/DockService;->getString(I)Ljava/lang/String;
    ...
    iget-object v6, v0, Lcom/android/settings_ex/bluetooth/DockService;->mCheckedItems:[Z

    move-object/from16 v0, p0

    iget-object v8, v0, Lcom/android/settings_ex/bluetooth/DockService;->mMultiClickListener:Landroid/content/DialogInterface$OnMultiChoiceClickListener;
    ...
    invoke-static {v0, v6}, Lcom/android/settings_ex/bluetooth/LocalBluetoothPreferences;->getDockAutoConnectSetting(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    iget-object v6, v0, Lcom/android/settings_ex/bluetooth/DockService;->mCheckedChangeListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    :goto_3
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/bluetooth/DockService;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v8, v0, Lcom/android/settings_ex/bluetooth/DockService;->mClickListener:Landroid/content/DialogInterface$OnClickListener;
    ...
    iput v0, v1, Lcom/android/settings_ex/bluetooth/DockService;->mStartIdAssociatedWithDialog:I
    ...
    iget-object v8, v0, Lcom/android/settings_ex/bluetooth/DockService;->mDismissListener:Landroid/content/DialogInterface$OnDismissListener;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/bluetooth/DockService;->getContentResolver()Landroid/content/ContentResolver;
