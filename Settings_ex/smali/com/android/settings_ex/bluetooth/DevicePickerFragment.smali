...
.method public constructor <init>()V
    ...
    .line 53
    new-instance v0, Lcom/android/settings_ex/bluetooth/DevicePickerFragment$1;

    invoke-direct {v0, p0}, Lcom/android/settings_ex/bluetooth/DevicePickerFragment$1;-><init>(Lcom/android/settings_ex/bluetooth/DevicePickerFragment;)V

    iput-object v0, p0, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->mReceiver:Landroid/content/BroadcastReceiver;
...
.method addPreferencesForActivity()V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->addPreferencesFromResource(I)V
    ...
    .line 77
    .local v0, filter:I
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->setFilter(I)V
    ...
    invoke-virtual {v2, v0}, Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;->getScanType(I)I

    move-result v2

    iput v2, p0, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->mScanType:I
...
.method public onBluetoothStateChanged(I)V
    ...
    iget v2, p0, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->mScanType:I

    invoke-virtual {v0, v1, v2}, Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;->startScanning(ZI)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    check-cast v0, Lcom/android/settings_ex/ProgressCategory;

    iput-object v0, p0, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->mProgressCategory:Lcom/android/settings_ex/ProgressCategory;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->mIntentFilter:Landroid/content/IntentFilter;
    ...
    iget-object v1, p0, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->mReceiver:Landroid/content/BroadcastReceiver;

    iget-object v2, p0, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->mIntentFilter:Landroid/content/IntentFilter;
...
.method public onResume()V
    ...
    .line 122
    iget-object v0, p0, Lcom/android/settings_ex/bluetooth/DevicePickerFragment;->mProgressCategory:Lcom/android/settings_ex/ProgressCategory;

    invoke-virtual {v0, v3}, Lcom/android/settings_ex/ProgressCategory;->setNoDeviceFoundAdded(Z)V
