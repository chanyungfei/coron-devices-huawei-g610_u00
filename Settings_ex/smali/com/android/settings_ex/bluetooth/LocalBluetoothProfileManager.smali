...
.field private mFtpProfile:Lcom/android/settings_ex/bluetooth/FtpProfile;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->BPP_PROFILE_UUIDS:[Landroid/os/ParcelUuid;
    ...
    sput-object v0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->BIP_PROFILE_UUIDS:[Landroid/os/ParcelUuid;
    ...
    sput-object v0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->HID_PROFILE_UUIDS:[Landroid/os/ParcelUuid;
    ...
    sput-object v0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->PRX_PROFILE_UUIDS:[Landroid/os/ParcelUuid;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;Lcom/android/settings_ex/bluetooth/CachedBluetoothDeviceManager;Lcom/android/settings_ex/bluetooth/BluetoothEventManager;)V
    ...
    iput-object v5, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mProfileNameMap:Ljava/util/Map;
    ...
    iput-object v5, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mServiceListeners:Ljava/util/Collection;
    ...
    invoke-virtual {v5, p0}, Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;->setProfileManager(Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;)V

    .line 115
    iget-object v5, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mEventManager:Lcom/android/settings_ex/bluetooth/BluetoothEventManager;

    invoke-virtual {v5, p0}, Lcom/android/settings_ex/bluetooth/BluetoothEventManager;->setProfileManager(Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;)V
    ...
    :cond_0
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->updateLocalProfiles([Landroid/os/ParcelUuid;)V
    ...
    .end local v2           #len$:I
    :cond_1
    new-instance v5, Lcom/android/settings_ex/bluetooth/HidProfile;

    iget-object v6, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mLocalAdapter:Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;

    invoke-direct {v5, p1, v6}, Lcom/android/settings_ex/bluetooth/HidProfile;-><init>(Landroid/content/Context;Lcom/android/settings_ex/bluetooth/LocalBluetoothAdapter;)V

    iput-object v5, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mHidProfile:Lcom/android/settings_ex/bluetooth/HidProfile;

    .line 130
    iget-object v5, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mHidProfile:Lcom/android/settings_ex/bluetooth/HidProfile;

    const-string v6, "HID"

    const-string v7, "android.bluetooth.input.profile.action.CONNECTION_STATE_CHANGED"

    invoke-direct {p0, v5, v6, v7}, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->addProfile(Lcom/android/settings_ex/bluetooth/LocalBluetoothProfile;Ljava/lang/String;Ljava/lang/String;)V

    .line 133
    new-instance v5, Lcom/android/settings_ex/bluetooth/PanProfile;

    invoke-direct {v5, p1}, Lcom/android/settings_ex/bluetooth/PanProfile;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mPanProfile:Lcom/android/settings_ex/bluetooth/PanProfile;

    .line 134
    iget-object v5, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mPanProfile:Lcom/android/settings_ex/bluetooth/PanProfile;

    const-string v6, "PAN"

    const-string v7, "android.bluetooth.pan.profile.action.CONNECTION_STATE_CHANGED"

    invoke-direct {p0, v5, v6, v7}, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->addPanProfile(Lcom/android/settings_ex/bluetooth/LocalBluetoothProfile;Ljava/lang/String;Ljava/lang/String;)V

    .line 139
    new-instance v5, Lcom/android/settings_ex/bluetooth/PbapServerProfile;

    invoke-direct {v5, p1}, Lcom/android/settings_ex/bluetooth/PbapServerProfile;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mPbapProfile:Lcom/android/settings_ex/bluetooth/PbapServerProfile;

    .line 145
    new-instance v5, Lcom/android/settings_ex/bluetooth/FtpProfile;

    iget-object v6, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mContext:Landroid/content/Context;

    invoke-direct {v5, v6}, Lcom/android/settings_ex/bluetooth/FtpProfile;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mFtpProfile:Lcom/android/settings_ex/bluetooth/FtpProfile;

    .line 146
    iget-object v5, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mFtpProfile:Lcom/android/settings_ex/bluetooth/FtpProfile;
...
.method updateLocalProfiles([Landroid/os/ParcelUuid;)V
    ...
    invoke-direct {v0, v1, p0}, Lcom/android/settings_ex/bluetooth/A2dpProfile;-><init>(Landroid/content/Context;Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;)V
...
.method declared-synchronized updateProfiles([Landroid/os/ParcelUuid;[Landroid/os/ParcelUuid;Ljava/util/Collection;Ljava/util/Collection;Z)V
    ...
    .line 375
    invoke-virtual {p0, p2}, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->updateLocalProfiles([Landroid/os/ParcelUuid;)V
    ...
    .line 422
    :cond_b
    sget-object v0, Lcom/android/settings_ex/bluetooth/FtpProfile;->UUIDS:[Landroid/os/ParcelUuid;
    ...
    iget-object v0, p0, Lcom/android/settings_ex/bluetooth/LocalBluetoothProfileManager;->mFtpProfile:Lcom/android/settings_ex/bluetooth/FtpProfile;
