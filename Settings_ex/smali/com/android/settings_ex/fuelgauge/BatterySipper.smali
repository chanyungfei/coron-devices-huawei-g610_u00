.class Lcom/android/settings_ex/fuelgauge/BatterySipper;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings_ex/fuelgauge/BatterySipper$UidToDetail;
    }
.end annotation
...
.field drainType:Lcom/android/settings_ex/fuelgauge/PowerUsageDetail$DrainType;
...
# direct methods
.method constructor <init>(Landroid/content/Context;Ljava/util/ArrayList;Landroid/os/Handler;Ljava/lang/String;Lcom/android/settings_ex/fuelgauge/PowerUsageDetail$DrainType;ILandroid/os/BatteryStats$Uid;[D)V
    .locals 2
    .parameter "context"
    .parameter
    .parameter "handler"
    ...
    iput-object v0, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->icon:Landroid/graphics/drawable/Drawable;
    ...
    iput-wide v0, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->value:D
...
# virtual methods
.method public compareTo(Lcom/android/settings_ex/fuelgauge/BatterySipper;)I
    .locals 4
    .parameter "other"
    ...
    invoke-virtual {p0}, Lcom/android/settings_ex/fuelgauge/BatterySipper;->getSortValue()D
...
.method public bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    .end local p1
    invoke-virtual {p0, p1}, Lcom/android/settings_ex/fuelgauge/BatterySipper;->compareTo(Lcom/android/settings_ex/fuelgauge/BatterySipper;)I
...
.method getNameIcon()V
    ...
    iget-object v0, v0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->mContext:Landroid/content/Context;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/fuelgauge/BatterySipper;->name:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->name:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/fuelgauge/BatterySipper;->defaultPackageName:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/fuelgauge/BatterySipper;->icon:Landroid/graphics/drawable/Drawable;
    :try_end_0
    ...
    iget-object v0, v0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->icon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v5, v0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->icon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/fuelgauge/BatterySipper$UidToDetail;->name:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/fuelgauge/BatterySipper$UidToDetail;->icon:Landroid/graphics/drawable/Drawable;

    .line 195
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->defaultPackageName:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/fuelgauge/BatterySipper$UidToDetail;->packageName:Ljava/lang/String;

    .line 196
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->mUidCache:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->mHandler:Landroid/os/Handler;
...
.method getQuickNameIconForUid(Landroid/os/BatteryStats$Uid;)V
    ...
    iget-object v5, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->mUidCache:Ljava/util/HashMap;
    ...
    check-cast v4, Lcom/android/settings_ex/fuelgauge/BatterySipper$UidToDetail;

    .line 104
    .local v4, utd:Lcom/android/settings_ex/fuelgauge/BatterySipper$UidToDetail;
    iget-object v5, v4, Lcom/android/settings_ex/fuelgauge/BatterySipper$UidToDetail;->packageName:Ljava/lang/String;

    iput-object v5, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->defaultPackageName:Ljava/lang/String;

    .line 105
    iget-object v5, v4, Lcom/android/settings_ex/fuelgauge/BatterySipper$UidToDetail;->name:Ljava/lang/String;

    iput-object v5, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->name:Ljava/lang/String;

    .line 106
    iget-object v5, v4, Lcom/android/settings_ex/fuelgauge/BatterySipper$UidToDetail;->icon:Landroid/graphics/drawable/Drawable;

    iput-object v5, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->icon:Landroid/graphics/drawable/Drawable;

    .line 128
    .end local v4           #utd:Lcom/android/settings_ex/fuelgauge/BatterySipper$UidToDetail;
    :goto_0
    return-void

    .line 109
    :cond_0
    iget-object v5, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->mContext:Landroid/content/Context;
    ...
    iput v5, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->iconId:I
    ...
    iget v6, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->iconId:I
    ...
    iget-object v6, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->name:Ljava/lang/String;
    ...
    .line 126
    :try_start_0
    iget-object v5, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->mRequestQueue:Ljava/util/ArrayList;
...
.method getValues()[D
    ...
    .prologue
    .line 87
    iget-object v0, p0, Lcom/android/settings_ex/fuelgauge/BatterySipper;->values:[D
