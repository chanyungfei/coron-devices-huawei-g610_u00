...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-virtual {v5}, Lcom/android/settings_ex/vpn2/VpnDialog;->getProfile()Lcom/android/internal/net/VpnProfile;
    ...
    #calls: Lcom/android/settings_ex/vpn2/VpnSettings$LockdownConfigFragment;->getStringOrNull(Landroid/security/KeyStore;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v1, v5}, Lcom/android/settings_ex/vpn2/VpnSettings$LockdownConfigFragment;->access$000(Landroid/security/KeyStore;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 251
    :try_start_0
    invoke-direct {p0, v4}, Lcom/android/settings_ex/vpn2/VpnSettings;->connect(Lcom/android/internal/net/VpnProfile;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 267
    :cond_2
    invoke-virtual {v3, v4}, Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;->update(Lcom/android/internal/net/VpnProfile;)V
    ...
    invoke-direct {v3, v5, v4}, Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;-><init>(Landroid/content/Context;Lcom/android/internal/net/VpnProfile;)V

    .line 270
    .restart local v3       #preference:Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;
    invoke-virtual {v3, p0}, Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    iget-object v6, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mSelectedKey:Ljava/lang/String;

    invoke-virtual {v5, v6}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;

    .line 305
    .local v2, preference:Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;
    if-nez v2, :cond_1
    ...
    invoke-virtual {v2}, Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;->getProfile()Lcom/android/internal/net/VpnProfile;

    move-result-object v6

    invoke-direct {v3, v5, p0, v6, v4}, Lcom/android/settings_ex/vpn2/VpnDialog;-><init>(Landroid/content/Context;Landroid/content/DialogInterface$OnClickListener;Lcom/android/internal/net/VpnProfile;Z)V
    ...
    #calls: Lcom/android/settings_ex/vpn2/VpnSettings$LockdownConfigFragment;->getStringOrNull(Landroid/security/KeyStore;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v0, v3}, Lcom/android/settings_ex/vpn2/VpnSettings$LockdownConfigFragment;->access$000(Landroid/security/KeyStore;Ljava/lang/String;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/vpn2/VpnSettings;->setHasOptionsMenu(Z)V
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    iget-object v5, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mInfo:Lcom/android/internal/net/LegacyVpnInfo;
...
.method public onResume()V
    ...
    .line 159
    iget-boolean v7, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUnlocking:Z
    ...
    :cond_0
    iput-boolean v6, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUnlocking:Z
    ...
    .line 176
    iget-object v7, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mPreferences:Ljava/util/HashMap;
    ...
    invoke-direct {v3, v0, v4}, Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;-><init>(Landroid/content/Context;Lcom/android/internal/net/VpnProfile;)V

    .line 183
    .local v3, pref:Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;
    invoke-virtual {v3, p0}, Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
    ...
    .end local v3           #pref:Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;
    .end local v4           #profile:Lcom/android/internal/net/VpnProfile;
    .end local v5           #profiles:Ljava/util/List;,"Ljava/util/List<Lcom/android/internal/net/VpnProfile;>;"
    :cond_3
    iget-object v7, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mDialog:Lcom/android/settings_ex/vpn2/VpnDialog;
    ...
    invoke-virtual {v7, p0}, Lcom/android/settings_ex/vpn2/VpnDialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    .line 192
    iget-object v7, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mDialog:Lcom/android/settings_ex/vpn2/VpnDialog;

    invoke-virtual {v7}, Lcom/android/settings_ex/vpn2/VpnDialog;->show()V

    .line 196
    :cond_4
    iget-object v7, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUpdater:Landroid/os/Handler;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUpdater:Landroid/os/Handler;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/vpn2/VpnSettings;->registerForContextMenu(Landroid/view/View;)V
