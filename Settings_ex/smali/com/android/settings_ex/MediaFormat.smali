...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/MediaFormat;->MTP_PROJECTION:[Ljava/lang/String;
...
.method static synthetic access$000(Lcom/android/settings_ex/MediaFormat;)Z
    .locals 1
    .parameter "x0"

    .prologue
    .line 45
    invoke-direct {p0}, Lcom/android/settings_ex/MediaFormat;->getMtpStatus()Z
...
.method static synthetic access$100(Lcom/android/settings_ex/MediaFormat;I)Ljava/lang/String;
    .locals 1
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 45
    invoke-direct {p0, p1}, Lcom/android/settings_ex/MediaFormat;->getVolumeString(I)Ljava/lang/String;
...
.method static synthetic access$200(Lcom/android/settings_ex/MediaFormat;)Landroid/os/storage/StorageVolume;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$300(Lcom/android/settings_ex/MediaFormat;I)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$400(Lcom/android/settings_ex/MediaFormat;)V
    .locals 0
    .parameter "x0"
...
.method private establishFinalConfirmationState()V
    ...
    .prologue
    .line 149
    iget-object v1, p0, Lcom/android/settings_ex/MediaFormat;->mFinalView:Landroid/view/View;

    if-nez v1, :cond_0

    .line 150
    iget-object v1, p0, Lcom/android/settings_ex/MediaFormat;->mInflater:Landroid/view/LayoutInflater;
    ...
    invoke-direct {p0, v1}, Lcom/android/settings_ex/MediaFormat;->getVolumeString(I)Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/MediaFormat;->mFinalButton:Landroid/widget/Button;

    .line 158
    iget-object v1, p0, Lcom/android/settings_ex/MediaFormat;->mFinalButton:Landroid/widget/Button;
    ...
    iget-object v2, p0, Lcom/android/settings_ex/MediaFormat;->mFinalClickListener:Landroid/view/View$OnClickListener;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/MediaFormat;->setContentView(Landroid/view/View;)V
...
.method private establishInitialState()V
    ...
    .prologue
    .line 178
    iget-object v1, p0, Lcom/android/settings_ex/MediaFormat;->mInitialView:Landroid/view/View;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/MediaFormat;->mInitiateButton:Landroid/widget/Button;

    .line 187
    iget-object v1, p0, Lcom/android/settings_ex/MediaFormat;->mInitiateButton:Landroid/widget/Button;

    const v2, 0x7f0b05d3

    invoke-direct {p0, v2}, Lcom/android/settings_ex/MediaFormat;->getVolumeString(I)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings_ex/MediaFormat;->mInitiateListener:Landroid/view/View$OnClickListener;
...
.method private getMtpPath()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/settings_ex/MediaFormat;->mContentResolver:Landroid/content/ContentResolver;

    invoke-static {}, Landroid/provider/MediaStore;->getMtpTransferFileUri()Landroid/net/Uri;

    move-result-object v1

    sget-object v2, Lcom/android/settings_ex/MediaFormat;->MTP_PROJECTION:[Ljava/lang/String;
...
.method private getMtpStatus()Z
    ...
    .prologue
    .line 258
    invoke-direct {p0}, Lcom/android/settings_ex/MediaFormat;->getMtpPath()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings_ex/MediaFormat;->mVolumePath:Ljava/lang/String;
...
.method private getVolumeString(I)Ljava/lang/String;
    ...
    .prologue
    .line 272
    iget-object v3, p0, Lcom/android/settings_ex/MediaFormat;->mVolumeDescription:Ljava/lang/String;

    if-eqz v3, :cond_0

    iget-boolean v3, p0, Lcom/android/settings_ex/MediaFormat;->mIsInternalSD:Z

    if-nez v3, :cond_2

    iget-boolean v3, p0, Lcom/android/settings_ex/MediaFormat;->mIsUsbStorage:Z
    ...
    .line 274
    invoke-virtual {p0, p1}, Lcom/android/settings_ex/MediaFormat;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/MediaFormat;->getString(I)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/settings_ex/MediaFormat;->mVolumeDescription:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/settings_ex/MediaFormat;->mVolumeDescription:Ljava/lang/String;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v1, p0, Lcom/android/settings_ex/MediaFormat;->mIsUsbStorage:Z
    ...
    iput-object v1, p0, Lcom/android/settings_ex/MediaFormat;->mVolumeDescription:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/MediaFormat;->mVolumePath:Ljava/lang/String;
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/android/settings_ex/MediaFormat;->mIsInternalSD:Z

    .line 214
    :cond_1
    invoke-virtual {p0}, Lcom/android/settings_ex/MediaFormat;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v1

    iput-object v1, p0, Lcom/android/settings_ex/MediaFormat;->mContentResolver:Landroid/content/ContentResolver;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/MediaFormat;->setTitle(Ljava/lang/CharSequence;)V
