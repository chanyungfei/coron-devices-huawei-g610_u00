...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings_ex/DeviceAdminAdd;->getMainLooper()Landroid/os/Looper;

    move-result-object v8

    invoke-direct {v7, v8}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V

    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mHandler:Landroid/os/Handler;

    .line 92
    const-string v7, "device_policy"

    invoke-virtual {p0, v7}, Lcom/android/settings_ex/DeviceAdminAdd;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Landroid/app/admin/DevicePolicyManager;

    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mDPM:Landroid/app/admin/DevicePolicyManager;

    .line 94
    invoke-virtual {p0}, Lcom/android/settings_ex/DeviceAdminAdd;->getIntent()Landroid/content/Intent;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mDeviceAdmin:Landroid/app/admin/DeviceAdminInfo;
    :try_end_1
    ...
    iput-boolean v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mRefreshing:Z

    .line 136
    iget-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    .line 137
    iget-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mDeviceAdmin:Landroid/app/admin/DeviceAdminInfo;
    ...
    :cond_2
    iget-boolean v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mRefreshing:Z
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings_ex/DeviceAdminAdd;->setResult(I)V
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mAddMsgText:Ljava/lang/CharSequence;

    .line 155
    const v7, 0x7f040034

    invoke-virtual {p0, v7}, Lcom/android/settings_ex/DeviceAdminAdd;->setContentView(I)V

    .line 157
    const v7, 0x7f080071

    invoke-virtual {p0, v7}, Lcom/android/settings_ex/DeviceAdminAdd;->findViewById(I)Landroid/view/View;

    move-result-object v7

    check-cast v7, Landroid/widget/ImageView;

    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mAdminIcon:Landroid/widget/ImageView;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mAdminName:Landroid/widget/TextView;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mAdminDescription:Landroid/widget/TextView;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mAddMsg:Landroid/widget/TextView;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mAddMsgExpander:Landroid/widget/ImageView;

    .line 163
    iget-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mAddMsg:Landroid/widget/TextView;

    new-instance v8, Lcom/android/settings_ex/DeviceAdminAdd$1;

    invoke-direct {v8, p0}, Lcom/android/settings_ex/DeviceAdminAdd$1;-><init>(Lcom/android/settings_ex/DeviceAdminAdd;)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings_ex/DeviceAdminAdd;->toggleMessageEllipsis(Landroid/view/View;)V
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mAdminWarning:Landroid/widget/TextView;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mAdminPolicies:Landroid/view/ViewGroup;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mCancelButton:Landroid/widget/Button;

    .line 175
    iget-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mCancelButton:Landroid/widget/Button;

    new-instance v8, Lcom/android/settings_ex/DeviceAdminAdd$2;

    invoke-direct {v8, p0}, Lcom/android/settings_ex/DeviceAdminAdd$2;-><init>(Lcom/android/settings_ex/DeviceAdminAdd;)V
    ...
    iput-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mActionButton:Landroid/widget/Button;

    .line 181
    iget-object v7, p0, Lcom/android/settings_ex/DeviceAdminAdd;->mActionButton:Landroid/widget/Button;

    new-instance v8, Lcom/android/settings_ex/DeviceAdminAdd$3;

    invoke-direct {v8, p0}, Lcom/android/settings_ex/DeviceAdminAdd$3;-><init>(Lcom/android/settings_ex/DeviceAdminAdd;)V
...
.method updateInterface()V
    ...
    invoke-static {v5, v8}, Lcom/android/settings_ex/DeviceAdminAdd;->setViewVisibility(Ljava/util/ArrayList;I)V
    ...
    invoke-virtual {p0, v6, v7}, Lcom/android/settings_ex/DeviceAdminAdd;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v5}, Lcom/android/settings_ex/DeviceAdminAdd;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/DeviceAdminAdd;->getText(I)Ljava/lang/CharSequence;
