...
.method private finishDelayedAndShowLockScreen(I)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->findViewById(I)Landroid/view/View;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->setContentView(I)V
    ...
    invoke-virtual {p0, v5, v4}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->setResultData(ILandroid/content/Intent;)V

    .line 100
    invoke-virtual {p0}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->getIntent()Landroid/content/Intent;
    ...
    iput v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAppWidgetId:I
    ...
    iput-object v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mExtraConfigureOptions:Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->setRequestedOrientation(I)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->findViewById(I)Landroid/view/View;

    move-result-object v4

    check-cast v4, Landroid/widget/GridView;

    iput-object v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mGridView:Landroid/widget/GridView;
    ...
    invoke-virtual {p0}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->getWindowManager()Landroid/view/WindowManager;
    ...
    .line 117
    invoke-virtual {p0}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->getResources()Landroid/content/res/Resources;
    ...
    .line 121
    iget-object v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mGridView:Landroid/widget/GridView;
    ...
    iput-object v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAppWidgetManager:Landroid/appwidget/AppWidgetManager;

    .line 124
    new-instance v4, Lcom/android/settings_ex/AppWidgetLoader;
    ...
    invoke-direct {v4, p0, v5, p0}, Lcom/android/settings_ex/AppWidgetLoader;-><init>(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;Lcom/android/settings_ex/AppWidgetLoader$ItemConstructor;)V

    iput-object v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAppWidgetLoader:Lcom/android/settings_ex/AppWidgetLoader;

    .line 125
    iget-object v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAppWidgetLoader:Lcom/android/settings_ex/AppWidgetLoader;

    invoke-virtual {p0}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->getIntent()Landroid/content/Intent;

    move-result-object v5

    invoke-virtual {v4, v5}, Lcom/android/settings_ex/AppWidgetLoader;->getItems(Landroid/content/Intent;)Ljava/util/List;

    move-result-object v4

    iput-object v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mItems:Ljava/util/List;

    .line 126
    new-instance v4, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity$AppWidgetAdapter;

    iget-object v5, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mItems:Ljava/util/List;

    invoke-direct {v4, p0, v5}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity$AppWidgetAdapter;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAppWidgetAdapter:Lcom/android/settings_ex/KeyguardAppWidgetPickActivity$AppWidgetAdapter;

    .line 127
    iget-object v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mGridView:Landroid/widget/GridView;

    iget-object v5, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAppWidgetAdapter:Lcom/android/settings_ex/KeyguardAppWidgetPickActivity$AppWidgetAdapter;
    ...
    iput-object v4, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->finish()V
...
.method setResultData(ILandroid/content/Intent;)V
    ...
    .line 142
    invoke-virtual {p0, p1, v0}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->setResult(ILandroid/content/Intent;)V
...
.method startActivityForResultSafely(Landroid/content/Intent;I)V
    ...
    .line 626
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->startActivityForResult(Landroid/content/Intent;I)V
    :try_end_0
