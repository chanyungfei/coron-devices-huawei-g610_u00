...
.field private static final STEP_UNINIT:I = 0x0

.field private static final STEP_WAITFORDONE:I = 0x3

.field private static final STEP_WAITFORMOUNTEDINNER:I = 0x2

.field private static final STEP_WAITFORUNMOUNTED:I = 0x1
...
.field private mSwtichToDirect:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 279
    const-string v0, "NoSwap"

    iput-object v0, p0, Lcom/android/server/MountService;->mSwtichToDirect:Ljava/lang/String;

    .line 280
    iput v1, p0, Lcom/android/server/MountService;->mStep:I

    .line 281
    iput-boolean v1, p0, Lcom/android/server/MountService;->bNewConState:Z
...
.method private HanldeSwitchState(Ljava/lang/String;I)V
    .locals 12
    .parameter "path"
    .parameter "newstate"
    ...
    .line 4217
    .local v2, bFinished:Z
    const/4 v3, 0x0

    .line 4218
    .local v3, bNotifyUsr:Z
    const/4 v1, 0x0
    ...
    const-string v6, "input error in HanldeSwitchState"
    ...
    iput-object v5, p0, Lcom/android/server/MountService;->mSwtichToDirect:Ljava/lang/String;
    ...
    .line 4229
    :cond_0
    iget-object v5, p0, Lcom/android/server/MountService;->mSwtichToDirect:Ljava/lang/String;

    const-string v6, "SwapToInternal"
    ...
    const-string v6, "Swap to external removed"
    ...
    invoke-direct {p0, v5}, Lcom/android/server/MountService;->updateSwapSate(Ljava/lang/String;)V
    ...
    .line 4402
    iput v11, p0, Lcom/android/server/MountService;->mStep:I
    ...
    const-string v0, "switch_exception"

    .line 4410
    .local v0, action:Ljava/lang/String;
    :goto_1
    invoke-direct {p0, v0}, Lcom/android/server/MountService;->sendSDSwapIntentByHW(Ljava/lang/String;)V
    ...
    .line 4240
    :cond_4
    iget v5, p0, Lcom/android/server/MountService;->mStep:I
    ...
    const-string v7, "Swap to internal step 1 state = "
    ...
    const-string v6, "succefully unmount external sdcard but need wait unmount internal"
    ...
    const-string v6, "succefully unmount internal sdcard no we can mount external sdcard in sdcard2"

    invoke-static {v5, v6}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 4253
    iput v10, p0, Lcom/android/server/MountService;->mStep:I
    ...
    const-string v6, "Swap to failed to unmout"
    ...
    const-string v6, "succefully mount internal sdcard in sdcard ;swap is done"

    invoke-static {v5, v6}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 4270
    iput v7, p0, Lcom/android/server/MountService;->mStep:I

    .line 4272
    iput-boolean v11, p0, Lcom/android/server/MountService;->bNewConState:Z
    ...
    const-string v6, "failed to mount external sdcard in sdcard2"
    ...
    const-string v6, "succefully mount external sdcard in sdcard2 ;swap is done"
    ...
    const-string v6, "failed mount external sdcard in sdcard2 ;swap is done"
    ...
    const-string v6, "SwapToExternal"
    ...
    const-string v7, "Swap to external step 1 state = "
    ...
    const-string v6, "succefully unmount enternal sdcard"
    ...
    .line 4309
    iput-boolean v8, p0, Lcom/android/server/MountService;->bNewConState:Z

    .line 4310
    const-string v5, "/storage/sdcard1"

    invoke-virtual {p0, v5}, Lcom/android/server/MountService;->mountVolume(Ljava/lang/String;)I
    ...
    const-string v6, "should not go to here in SwapToExternal"
    ...
    const-string v6, "succefully unmount internal sdcard in SwapToExternal"
    ...
    const-string v6, "state is worng in SwapToExternal"
    ...
    const-string v6, "succefully mount internal sdcard in SwapToExternal"
    ...
    const-string v6, "succefully mount external sdcard in SwapToExternal"
    ...
    const-string v6, "state is worng mounted case in SwapToExternal"
    ...
    const-string v6, "state is NoMedia in SwapToExternal"
    ...
    const-string v6, "state is worng last case in SwapToExternal"
...
.method static synthetic access$3602(Lcom/android/server/MountService;Z)Z
    ...
    .prologue
    .line 113
    iput-boolean p1, p0, Lcom/android/server/MountService;->mMountSwap:Z
...
.method private notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;IIZ)V
    ...
    .line 1530
    invoke-direct {p0, p2, p4}, Lcom/android/server/MountService;->HanldeSwitchState(Ljava/lang/String;I)V
...
.method private readStorageListLocked()V
    ...
    const v4, #android:string@storage_internal#t
...
.method private sendSDSwapIntentByHW(Ljava/lang/String;)V
    .locals 6
    .parameter "action"
    ...
    const-string v5, "sendSDSwapIntentByHW:"
...
.method private updateSwapSate(Ljava/lang/String;)V
    .locals 1
    .parameter "state"

    .prologue
    .line 4417
    const-string v0, "vold_swap_state"
...
.method public manuleSwitch(Ljava/lang/String;)V
    .locals 8
    .parameter "path"
    ...
    .line 4141
    .local v2, rc:I
    const-string v3, "persist.sys.mainstorage"
    ...
    .line 4142
    .local v1, palace:Ljava/lang/String;
    const/4 v0, 0x0
    ...
    const-string v5, "persist.sys.mainstorage = "
    ...
    .line 4146
    const-string v3, "NoSwap"

    iput-object v3, p0, Lcom/android/server/MountService;->mSwtichToDirect:Ljava/lang/String;
    ...
    const-string v4, "Swtich To internal"

    invoke-static {v3, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 4171
    const-string v3, "SwapToInternal"

    iput-object v3, p0, Lcom/android/server/MountService;->mSwtichToDirect:Ljava/lang/String;

    .line 4172
    iput v6, p0, Lcom/android/server/MountService;->mStep:I

    .line 4173
    const-string v3, "/storage/sdcard0"

    invoke-virtual {p0, v3, v6, v7}, Lcom/android/server/MountService;->unmountVolume(Ljava/lang/String;ZZ)V
    ...
    const-string v4, "Swtich To external"

    invoke-static {v3, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 4202
    const-string v3, "SwapToExternal"
...
.method public mountVolume(Ljava/lang/String;)I
    ...
    .line 2458
    iget-boolean v3, p0, Lcom/android/server/MountService;->bNewConState:Z
    ...
    .line 2459
    iput-boolean v5, p0, Lcom/android/server/MountService;->bNewConState:Z
    ...
    const-string v6, "mountVolume with swap"
    ...
    invoke-direct {p0, v3, v2, v6}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    .line 2481
    iput-boolean v5, p0, Lcom/android/server/MountService;->mMountSwap:Z
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    const-string v4, "VoldResponseCode.VolumeDiskInserted"
    ...
    .line 1317
    .local v23, palace:Ljava/lang/String;
    const-string v3, "external"
    ...
    .line 1324
    .local v25, primaryVolume:Landroid/os/storage/StorageVolume;
    monitor-exit v4
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    .line 1331
    .end local v25           #primaryVolume:Landroid/os/storage/StorageVolume;
    :cond_5
    ...
    .line 1462
    .end local v12           #bSwap:Z
    .end local v23           #palace:Ljava/lang/String;
    :goto_4
    if-eqz v9, :cond_2
    ...
    .line 1324
    .restart local v12       #bSwap:Z
    .restart local v23       #palace:Ljava/lang/String;
    ...
    iget-object v4, v0, Lcom/android/server/MountService;->mSwtichToDirect:Ljava/lang/String;
    ...
    const-string v4, "[SWAP] main stroage is removed MTK_2SDCARD_SWAP"
    ...
    invoke-direct {v0, v1, v3}, Lcom/android/server/MountService;->HanldeSwitchState(Ljava/lang/String;I)V
    ...
    .line 1423
    .local v26, secondaryVolume:Landroid/os/storage/StorageVolume;
    monitor-exit v4
    :try_end_5
    ...
    .line 1440
    .end local v26           #secondaryVolume:Landroid/os/storage/StorageVolume;
    :cond_b
    const-string v3, "android.intent.action.MEDIA_EJECT"
    ...
    .line 1433
    .restart local v26       #secondaryVolume:Landroid/os/storage/StorageVolume;
    :catchall_3
    move-exception v3
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/os/storage/StorageVolume;->toString()Ljava/lang/String;
...
.method public setUsbMassStorageEnabled(Z)V
    ...
    invoke-direct {v0, v6}, Lcom/android/server/MountService;->isExternalStorage(Ljava/lang/String;)Z
    ...
    iput-boolean v13, v0, Lcom/android/server/MountService;->mUnmountSwap:Z
    ...
    iput-boolean v13, v0, Lcom/android/server/MountService;->bNewConState:Z
    ...
    invoke-direct {v0, v13, v6}, Lcom/android/server/MountService;->updateDefaultPathForSwap(ZLjava/lang/String;)V
    ...
    const-string v15, "MTK_SHARED_SDCARD is enabled, need to swap sd when UMS is enabled: mUnmountSwap: "
    ...
    iget-boolean v15, v0, Lcom/android/server/MountService;->mUnmountSwap:Z
...
#.method static synthetic access$iget-mUnmountPrimary-12311a(Lcom/android/server/MountService;)Z
#    .locals 1
#    .parameter "x0"
#    .prologue
...
# Remove the first '#' if you want to enable this method. It might be invoked from codes of BOSP.
#.method static synthetic access$iput-mUnmountPrimary-fc1a9e(Lcom/android/server/MountService;Z)Z
#    .locals 0
#    .parameter "x0"
#    .parameter "x1"
#    .prologue
