...
.method private setAudioMode(I)V
    ...
    const-string/jumbo v9, "setAudioMode enter..."
    ...
    const-string/jumbo v10, "set mode = "
    ...
    const-string v9, "Do not need to switch normal mode for held call"
    ...
    .end local v3           #fgIsAlive:Z
    :pswitch_0
    const-string v8, "CallManager"

    const-string/jumbo v9, "requestAudioFocus on STREAM_RING"
    ...
    const-string/jumbo v9, "requestAudioFocus on STREAM_VOICE_CALL"
    ...
    .restart local v3       #fgIsAlive:Z
    :cond_3
    const-string v4, ""

    .line 2668
    .local v4, headsetState:Ljava/lang/String;
    if-le p1, v11, :cond_5
    ...
    new-instance v9, Lcom/android/internal/telephony/CallManager$2;

    invoke-direct {v9, p0, v7}, Lcom/android/internal/telephony/CallManager$2;-><init>(Lcom/android/internal/telephony/CallManager;I)V
    ...
    const-string/jumbo v10, "set AudioManager mode "
    ...
    iput v8, p0, Lcom/android/internal/telephony/CallManager;->mCurrentAudioMode:I

    .line 2717
    .end local v1           #bgIsAlive:Z
    .end local v3           #fgIsAlive:Z
    .end local v4           #headsetState:Ljava/lang/String;
    ...
    .restart local v1       #bgIsAlive:Z
    .restart local v3       #fgIsAlive:Z
    .restart local v4       #headsetState:Ljava/lang/String;
    :cond_5
    move v7, p1
