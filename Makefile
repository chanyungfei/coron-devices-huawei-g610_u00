...
#-----------------------------------------------------------------------------
vendor_remove_dirs := app vendor/operator/app delapp themes media/audio/notifications  media/video 
...
#-----------------------------------------------------------------------------
vendor_modify_jars := framework hwframework mediatek-framework pm secondary-framework services telephony-common
...
#-----------------------------------------------------------------------------
baidu_remove_apps := BaiduMap BaiduUpdate iReader GameCenter BaiduAppsearch BaiduBrowser SearchBox
